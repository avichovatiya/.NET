...
<body>
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link active" class="nav-link" href="services.aspx">Services</a>
    </li>
    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="form-group">
            Name:
            <asp:TextBox class="form-control" ID="TextBox1" placeholder="Enter Service name" runat="server"></asp:TextBox>
        </div>
        <div class="form-group">
            Price<label for="pwd">:</label>
            <asp:TextBox class="form-control" ID="TextBox2" placeholder="Enter Service Price" runat="server"></asp:TextBox>
            <label for="pwd">
                <br />
                qty:</label><asp:TextBox class="form-control" ID="TextBox3" placeholder="Enter Qty" runat="server"></asp:TextBox>
        </div>
